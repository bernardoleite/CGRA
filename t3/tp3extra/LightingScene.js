...
LightingScene.prototype.init = function(application) {
	...
	this.cylinder = new MyCylinder(this, 8, 20); // 8 lados e 20 andares
	this.lamp = new MyLamp(this, 100, 40); // 8 lados e 20 andares
...
/*
	...
	this.materialFloor.setAmbient(0.7,0.7,0.7,1);
	this.materialFloor.setDiffuse(0.5,0,0,1);
...
//3.4
	...
	this.lights[0].setAmbient(1, 1, 1, 1); // alterado para se ver prisma melhor
	this.lights[0].setDiffuse(1.0, 1.0, 1.0, 1.0);
	this.lights[0].setSpecular(1,1,0,1); // 2.8
	this.lights[0].enable();

	this.lights[1].setAmbient(1, 1, 1, 1); //alterado para se ver prisma melhor
