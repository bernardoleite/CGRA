...
function MyLamp(scene, nrslicess, nrstacks) {
...
var nrslices = 0;
 ...
 MyLamp.prototype.func1 = function(aux1,aux2,ang,alturaAng) {
 ...
 MyLamp.prototype.func11 = function(aux1,aux2,ang,alturaAng) {
 ...
 MyLamp.prototype.lastfunc = function(nrslices,nrstack, aux3) {
 ...
 MyLamp.prototype.lastfunc2 = function(nrslices,nrstack, aux3) {
			this.indices.push(
			 2 + nrslices+this.andares * this.lados , 
			1+this.andares * this.lados ,
 ...
 MyLamp.prototype.func2 = function(aux1,aux2,aux3,ang,alturaAng, nrstack, nrslices) {
 ...
 MyLamp.prototype.func22 = function(aux1,aux2,aux3,ang,alturaAng, nrstack, nrslices) {
